...
import { ArrowBigLeft, ArrowBigRight, ArrowLeft, ArrowRight, ShoppingCart, Star } from "lucide-react"
        ...
        <div className="w-full flex gap-8">
          ...
          <div className="flex flex-2 flex-col gap-4">
            <Card className="flex flex-col gap-4">
              ...
              <Button onClick={handleAddToCart} variant="primary" className="w-full gap-2">

  ...
  return (
    <label className="flex items-center gap-2.5 cursor-pointer group">
      <div className="relative flex items-center justify-center">
        ...
        />
        <div
          className={`w-4 h-4 rounded border-2 transition-colors peer-checked:bg-primary peer-checked:border-primary group-hover:border-primary/50 ${hasError ? "border-error" : "border-border"}`}
        />
        <Check
          size={10}
